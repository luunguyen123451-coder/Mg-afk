...
centre of the village. The app shows it automatically as a shop card and the
Watchlist can auto-buy items from it.

**New items in the Thunder Shop:**

- **Thunderspire** (Celestial) — fast multi-harvest, grows Thunderpeel and
  Stormcap during Thunderstorms; holds up to 16 crops (new max!)
- **Thundercharged** (Mutation) — 7× sell bonus, better than Frozen (6×)
- **Thunder Egg** (Legendary, 400M coins / 399 Donuts) — hatches Bat,
  Platypus, or Thunder Wolf (Mythical rideable with Thundercharger ability)
- **New Seeds**: Cattail (Rare), Cardoon (Legendary), Prickly Pear (Mythical),
  Milkcap (Divine)
- **New Decor**: Moon & Star Windchime (Rare), Wind Spinner (Mythical),
  Wind Turner (Divine); returning Halloween: Gravestones & Cauldron
